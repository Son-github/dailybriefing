...
## 📘 인프라 구성
<img width="404" height="484" alt="image" src="https://github.com/user-attachments/assets/fd3066fd-5b6c-4061-ba55-f568a5090d45" />
 * VPC
...
<img width="404" height="484" alt="image" src="https://github.com/user-attachments/assets/464ce0e1-70ef-46f8-9eeb-13cee67afd1f" />
 * ECS
  * CI/CD 자동화를 통해 항상 최신버전이 유지되도록 설정
  * Fargate를 기반으로하여 트래픽이 생기면 인스턴스 작동 보통 기간에는 인스턴스 작동 X

<img width="404" height="484" alt="image" src="https://github.com/user-attachments/assets/e8006041-4840-4bd7-8552-69fd5cdc1a87" />
 * RDS
  * 단일 AZ에 생성하여 안정성은 줄지만 비용효율성을 높임
  * Aurora 대신 RDS를 활용해 성능보단 비용 절감을 선택

<img width="404" height="524" alt="image" src="https://github.com/user-attachments/assets/fd52aeb1-24c9-46d4-a539-1073be1b6d9d" />
<img width="404" height="484" alt="image" src="https://github.com/user-attachments/assets/c10ca64e-92f9-4ac6-9cf2-5f6e1c413feb" />
 * CloudFront + S3
  * 정적자원(Frontend)을 위치하여 비용 절감 및 성능 최적화를 이뤄냄

<img width="404" height="524" alt="image" src="https://github.com/user-attachments/assets/e6db909e-c50e-451c-b745-ea99a070ab53" />
 * CloudWatch
  * 장애 감시 및 로그 확인
